...
public class WhatsappController {
    ...
    public int sendMessage(@RequestParam("message") Message message,@RequestParam("sender") User sender,@RequestParam("group") Group group) throws Exception{
    ...
    public String changeAdmin(@RequestParam("approver") User approver, @RequestParam("user") User user,@RequestParam("group") Group group) throws Exception{
        //Throw "Group does not exist" if the mentioned group does not exist
